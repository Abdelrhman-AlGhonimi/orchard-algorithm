...
def format_schedule(solution, data):
    """Format the schedule in a readable format for display and file output"""
    operations = data['operations']
    rooms = data['rooms']
...
def check_schedule_for_interference(solution, operations, rooms):
    """Check the final schedule for any interference and log alerts"""
